...
<body>
  ...
  <div class="body_form">
    ...
    <div class="position-relative">
        ...
        <x-text-input id="password" class="form-control pr-5" type="password" name="password" required autocomplete="new-password" />
        <button type="button" class="btn btn-outline-secondary position-absolute end-0 top-50 translate-middle-y me-2 toggle-password" data-target="password">
...
<div class="form-group mb-4">
    <div class="position-relative">
        ...
        <x-text-input id="password_confirmation" class="form-control pr-5" type="password" name="password_confirmation" required autocomplete="new-password" />
        <button type="button" class="btn btn-outline-secondary position-absolute end-0 top-50 translate-middle-y me-2 toggle-password" data-target="password_confirmation">
            <i class="fas fa-eye"></i>
        </button>
