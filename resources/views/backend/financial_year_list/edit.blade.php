...
@section('main_section')  
    <div class="page-ti" style="padding: 20px 30px 10px 30px;">
                ...
                <ol class="breadcrumb mb-0 d-flex align-items-center">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="javascript:void(0)" class="link">Edit Financial Year</a></li>
                </ol>
            </nav>
                        <h3 class="mt-3 text-white mb-0 fw-bold">Add Client</h3>
                    </div>
...
<form action="{{route('backend.fy_year.update')}}" method="POST">
    @csrf
    <div class="row lable_font">
        <div class="col-md-4 mt-4">
            <label class="control-label">Year</label>
            <input class="form-control form-white input_border" name="name" placeholder="Year" type="text" value="{{$year->name}}" >
            @error('name')
