...
<div class="page-ti" style="padding: 20px 30px 10px 30px;">
                ...
                <ol class="breadcrumb mb-0 d-flex align-items-center">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="javascript:void(0);" class="link">Edit Employee</a></li>
                </ol>
            </nav>
                            ...
                            <form action="{{route('backend.employee.update', [Crypt::encrypt($user->id)])}}" method="POST">
                                ...
                                <div class="row lable_font">
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <input type="text" name="name" class="form-control form-white input_border" placeholder="Your name"
                                            value="{{$user->name ?? ''}}" required>
                                    </div>
                                    <div class="col-md-4 mt-4">
                                        <label class="control-label">Email</label>
                                        <input name="email" class="form-control form-white input_border" placeholder="email id" type="email"
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <!-- <select id="clients" class="form-control mt-4" aria-placeholder="Name"
                                            name="client">
