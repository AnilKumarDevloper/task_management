        ...
        <div class="row">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 d-flex align-items-center">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="javascript:void(0);" class="link">Add Employee</a></li>
                </ol>
            </nav>
            ...
            <form action="{{ route('backend.employee.store') }}" method="POST">
                ...
                <div class="row lable_font">
                    <div class="col-md-4 mt-4">
                        ...
                        <input name="name" class="form-control form-white input_border" placeholder="Your name" type="text" oninput="capitalizeEachWord(this)">
                        @error('name')
                    ...
                    <div class="col-md-4 mt-4">
                        ...
                        <input type="tel" class="form-control form-white input_border" placeholder="Phone" id="phone" name="phone"
                               value="{{ old('phone') }}"
                               maxlength="10" 
                               minlength="10" 
                               pattern="\d{10}" 
                    ...
                    <div class="col-md-4 mt-4">
                        ...
                        <div class="input-group">
                            <input name="password" class="form-control form-white input_border" placeholder="Password" type="password" id="password">
                    ...
                    <div class="col-md-4 mt-4">
                        ...
                        <div class="input-group">
                            <input name="password_confirmation" class="form-control form-white input_border" placeholder="Confirm Password" type="password" id="confirm_password">
